...
namespace COMP003A.LectureActivity7
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // you can set valeus to an index using the examples below:
            ...
            array1[3] = 20; // sets the value for index 2 to 20
            ...
            int[] array2 = new int[] { 1, 2, 3, 7, 9 }; // declares a single dimensional array element wit values

            /* arrays are zero-indexed, meaning first 'position' starts ar index 0
             ...
             * 
             * It is important to note that rrays cannot be dynamically resized/
            ...
            List<char> alphabet = new List<char>();// delcare an empty integet List
        ...
        {
            // you can use a for-loop or other looping statementsfor array traversals
            ...
            {
            // you can use a for-loop or other looping statments for array traversals
            for (int i = 0; i < array.Length; i++)
                {
                Console.WriteLine($"Array at index {i}: {array[i]}");
                }
            ...
            /// </summary>
            /// <param name="array"Integet array input</param>
            /// <returns></returns>
            static double GetAverage(int[] array)
            {
                int runningTotal = 0 ;

                // if you are planing to manipulate the contents of the array,
            ...
            /// <summary>
            /// List the traversal using a foreach loop
            /// </summary>
            /// <param name="list">Character list input</param>
            static void ListTraversal(List<char> list)
            {
                // you can use a feach-loop or other looping statements for list traversals
